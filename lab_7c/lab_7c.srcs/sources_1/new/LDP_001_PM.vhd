...
architecture Behavioral of LDP_001_PM is
  ...
  -- Define any signals that your architecture needs.
    ...
    signal enable_port: std_logic_vector ( 7 downto 0 ) := (others => '0');
    signal interrupt_vector : std_logic_vector( channels-1 downto 0 ) := (others => '0');
...
--interrupt
interrupt <= or_reduce ( interrupt_vector );
