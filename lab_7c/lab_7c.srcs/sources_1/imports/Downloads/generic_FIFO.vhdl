...
entity generic_FIFO is
  ...
  port(
    clk,rst : std_logic;
    wdata : in  std_logic_vector(bits-1 downto 0) := ( others => '0' );
    wen   : in  std_logic;
    ren   : in std_logic;
    enable_fifo : std_logic := '1'; 
    threshold : in std_logic_vector(clog2(depth)-1 downto 0) := (others=>'0');
    rdata : out std_logic_vector(bits-1 downto 0) := ( others => '0' );
...
architecture behavioral of generic_FIFO is
  ...
  signal reg : regs_t := ( others => ( others => '0' ) );
  signal reg_in : regs_t;
